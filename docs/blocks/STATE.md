...
**MVP + UI v2 + ADR-0016 bis ADR-0023 + Block-P-Iteration v0.9.3 + Pass-1-Batching v0.9.4 + Worker-Stability v0.9.5 + Worker-Idle-Throttle v0.9.6 + Server-Detail/Findings-Slim-Down v0.10.0 + TICKET-004-Test-Suite-Entkopplung + ADR-0029 Block-U-Worker-Concurrency — Ziel v0.11.0 (2026-05-23).**
...
(keiner — Block T abgeschlossen 2026-05-22, Branch `feat/block-t-eval-junction` lokal; Block R wurde auf main gemerged; Commit + Merge Block T auf User-Anweisung)
