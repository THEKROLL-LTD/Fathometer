...
- `RECOMMENDED_TRIVY_VERSION: str = "0.73.0"` — Version, die der Installer als pinned Binary herunterlädt **und** auf die der Agent-Lauf eine managed Trivy-Binary hebt (`auto_update_trivy`, TICKET-015). Wird beim Bump im selben Commit aktualisiert.
